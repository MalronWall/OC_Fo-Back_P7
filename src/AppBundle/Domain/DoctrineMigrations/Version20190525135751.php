 ...
 */
final class Version20190525135751 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_C7440455F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE clients_phones (client_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', phone_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_E6FFFA1219EB6921 (client_id), INDEX IDX_E6FFFA123B7323CB (phone_id), PRIMARY KEY(client_id, phone_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE clients_users (client_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_C300512E19EB6921 (client_id), INDEX IDX_C300512EA76ED395 (user_id), PRIMARY KEY(client_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE phone (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', brand VARCHAR(255) NOT NULL, model VARCHAR(255) NOT NULL, os VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, cpu VARCHAR(255) DEFAULT NULL, gpu VARCHAR(255) DEFAULT NULL, ram VARCHAR(255) DEFAULT NULL, memory VARCHAR(255) DEFAULT NULL, dimensions VARCHAR(255) DEFAULT NULL, weight VARCHAR(255) DEFAULT NULL, resolution VARCHAR(255) DEFAULT NULL, mainCamera VARCHAR(255) DEFAULT NULL, selfieCamera VARCHAR(255) DEFAULT NULL, sound VARCHAR(255) DEFAULT NULL, battery VARCHAR(255) DEFAULT NULL, colors VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', firstname VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, cp VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, phoneNumber VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
